...
module.exports = {
    ...
    Description: `View the bottom 10 Members with the lowest XP count in this Server`,
        ...
        Data.options = [
            {
                ...
                name: "xp_type",
                description: "Type of XP to show the Bottom 10 for",
                required: true,
                choices: [
    ...
    async execute(slashCommand)
    {
        ...
        if ( InputXpType === "TEXT" )
        {
            ...
            fetchedXpCollection = await GuildXp.find({ guildId: slashCommand.guildId }).sort({ textXp: "asc" }).limit(10);
        }
        else if ( InputXpType === "VOICE" )
        {
            ...
            fetchedXpCollection = await GuildXp.find({ guildId: slashCommand.guildId }).sort({ voiceXp: "asc" }).limit(10);
        }
